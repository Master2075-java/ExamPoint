...
// - Entity ID: 102019b0630795c7259bc87d39c55c4f024.
...
/**
 * Enumeration for SubscriptionPaymentStatus
 */
...
/**
 * Enumeration for SubscriptionTier
 */
...
export class SubscriptionORM {
  ...
  private constructor() {
    ...
    this.entityId = '102019b0630795c7259bc87d39c55c4f024';
...
function SubscriptionModelToValues(data: SubscriptionModel): Value[] {
  const fieldMappings = [
    ...
    { key: 'payment_status', type: DataType.enumeration, defaultValue: 0 },
    { key: 'start_date', type: DataType.string, defaultValue: '' },
    { key: 'renewal_date', type: DataType.string, defaultValue: '' },
  ...
  for (const value of values) {
    ...
    switch (value.name) {
      ...
      case 'user_id':
        ...
        break;
      case 'tier':
        data.tier = ParseValue(value, DataType.enumeration) as SubscriptionTier;
        break;
      case 'payment_status':
        data.payment_status = ParseValue(value, DataType.enumeration) as SubscriptionPaymentStatus;
        break;
      case 'start_date':
        data.start_date = ParseValue(value, DataType.string) as string;
        break;
      case 'renewal_date':
        data.renewal_date = ParseValue(value, DataType.string) as string;
        break;
      case 'amount':
