...
// - Entity Name: user.
// - Entity ID: 102019b0630795c7687ab8af37de757826c.
...
/**
 * Enumeration for UserSubscriptionStatus
 */
...
export class UserORM {
  ...
  private constructor() {
    ...
    this.entityId = '102019b0630795c7687ab8af37de757826c';
...
function UserModelToValues(data: UserModel): Value[] {
  const fieldMappings = [
    ...
    { key: 'subscription_status', type: DataType.enumeration, defaultValue: 0 },
    { key: 'registration_date', type: DataType.string, defaultValue: '' },
  ];
  ...
  for (const value of values) {
    ...
    switch (value.name) {
      ...
      case 'subscription_tier':
        data.subscription_tier = ParseValue(value, DataType.enumeration) as UserSubscriptionTier;
        break;
      case 'subscription_status':
        data.subscription_status = ParseValue(value, DataType.enumeration) as UserSubscriptionStatus;
        break;
      case 'registration_date':
        data.registration_date = ParseValue(value, DataType.string) as string;
        break;
    }
  }
